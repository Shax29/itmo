...
<html class='no-js' lang='en'>
  ...
  <body>
  <?php
    $_POST[preference] = ('Выберите размер,S,M,L,XL');
    ...
    <div class='large-12-center'>
      ...
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Перчатки мужские </a></li>
      <li>  Mad Max, Crazy MFG-850  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='141.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/141.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
     
    echo "<div class='product_info'>
     
     <div class='product_title'>
     <span class='title_name' name='title'> $tov[manuf], $tov[nazv] </span>
	 ...
	 <br><span class='price_tovar_standart'> Цена: $tov[cena] руб. </span>
...
$svoistva = ('Выберите размер,S,M,L,XL');
...
echo "</div>";
  ...
  echo "</div>";
    ...
    <br></br>
    <strong> Состав: $tov[sostav]</strong>
