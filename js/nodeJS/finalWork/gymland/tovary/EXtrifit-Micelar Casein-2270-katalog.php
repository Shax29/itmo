...
?> 
  ...
  <?php
    $_POST[preference] = ('Ваниль,Шоколад');
	$preference = explode(",", $_POST[preference]);
    foreach($preference as $_POST[preference]) {}
	
	$_POST[sostav] = ('В 100 г продукта содержится:\r\n\r\n    1464,5 кДж / 348,7 ккал; \r\n    75,1 г белков; \r\n    8,1 г углеводов; \r\n    1,8 г жиров;\r\n');
...
$sql_tov="SELECT * FROM tovary WHERE photo='153.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/153.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
    ...
    ?>  
       ...
       <!--<form method='post' action='../templates/comment.php'>-->
        ...
        //Редактирование отзыва
             ...
             $sql="UPDATE otzyv SET name='',comment='',advantage='',disadvantage='' WHERE id_otzyv='$_GET[edit_otzyv]'";
             mysql_query($sql);
             echo "<script>location.replace('/products/$tov[manuf]_$tov[nazv]_$tov[mass].php?items=$_GET[items]');</script>";
