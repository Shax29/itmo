...
<html class='no-js' lang='en'>
  ...
  <?php
    ...
    <div class='large-12-center'>
      ...
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Не выбрана категория </a></li>
      <li>  Pure Protein, Whey Protein  </li>
      </ul>
   <form action='' method='post' class='tovary_week_form' id='sort'>  
   <div class='product_conteiner'> 
     <?php 
 
 $sql_tov='SELECT * FROM tovary WHERE nazv='Whey Protein'';
 ...
 while($tov=mysql_fetch_array($rez_tov)) {  
     ...
     <img src='../photos/' name='photo' title='Pure Protein, Whey Protein' alt='Pure Protein, Whey Protein'/>
     </div>";
     
    echo "<div class='product_info'>
     
     <div class='product_title'>
     <span class='title_name' name='title'> Pure Protein, Whey Protein </span> <span class='tovar_of_the_week'> Товар недели! </span>
     <br> <span class='title_and_mass' name='title_and_mass'> Не выбрана категория,  гр. () </span>  
     ...
     <div class='product_price'>
          ...
          <span class='new_price' name='new_price'> Цена со скидкой:  руб. </span>
     <br> <span class='old_price' name='old_price'> Старая цена:  руб. </span>
...
echo "</div>";
    ...
    <strong style='font-size:14px;'>Whey Protein</strong>
