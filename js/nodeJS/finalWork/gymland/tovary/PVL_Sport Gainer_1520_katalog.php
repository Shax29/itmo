...
$sql_tov="SELECT * FROM tovary WHERE photo='149.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/149.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
