...
<html class='no-js' lang='en'>
  ...
  <?php
    ...
    <div class='large-12-center'>
	  ...
	  <li class='sport_eat_breadcrumbs'><a href='../clothes.php' rel='clothes'> Одежда </a></li>
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Сумки </a></li>
      <li>  Universal Nutrition, Сумка спортивная  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='142.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/142.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
