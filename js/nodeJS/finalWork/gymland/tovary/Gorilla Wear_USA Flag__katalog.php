...
<html class='no-js' lang='en'>
  ...
  <body>
  <?php
    $_POST[preference] = ('Выберите размер,M,XXL');
    ...
    <div class='large-12-center'>
      ...
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Футболки </a></li>
      <li>  Gorilla Wear, USA Flag  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='140.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/140.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
    ...
    echo "<div class='product_info'>
	 ...
	 <br><span class='price_tovar_standart'> $tov[cena] руб. </span>
...
$svoistva = ('Выберите размер,M,XXL');
