...
<html class='no-js' lang='en'>
  ...
  <?php
	...
	$_POST[sostav] = ('Kre-Alkalyn® (буфферезированный моногидрат креатина) 1500.00мг;');
    ...
    <div class='large-12-center'>
      ...
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Креатин </a></li>
      <li>  Labrada Nutrition, Kre-Alkalyn Creatin Concentrate  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='138.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/138.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
...
$sos = ('Kre-Alkalyn® (буфферезированный моногидрат креатина) 1500.00мг;');
$sostav = explode(";", $sos);
