...
<html class='no-js' lang='en'>
  ...
  <body>
  <?php
    $_POST[preference] = ('Выберите вкус,Ванила,Пина колада,Шоколад');
	$preference = explode(",", $_POST[preference]);
    foreach($preference as $_POST[preference]) {}
	
	$_POST[sostav] = ('Калории 842;
Жиры 3г; 
Холестерол 42мг; 
Натрий 142мг; 
Калий 125мг; 
...
Белок 35г; ');
    ...
    <div class='large-12-center'>
      ...
      <li>  Universal Nutrition, Gain Fast  </li>
      </ul>
 ...
 while(Array=mysql_fetch_array()) {    
     ...
     <img src='../photos/0.jpeg' name='photo' title='Universal Nutrition, Gain Fast' alt='Universal Nutrition, Gain Fast'/>
     </div>";
     
    echo "<div class='product_info'>
     
     <div class='product_title'>
     <span class='title_name' name='title'> Universal Nutrition, Gain Fast </span> <span class='tovar_of_the_week'> Товар недели! </span>
     ...
     <div class='product_price'>
          ...
          <span class='new_price' name='new_price'> Цена со скидкой: 4100 руб. </span>
     <br> <span class='old_price' name='old_price'> Старая цена: 4315 руб. </span>
...
$svoistva = ('Выберите вкус,Ванила,Пина колада,Шоколад');
...
GAIN FAST содержит необходимые витамины, минералы, электролиты. </span>
...
<span style='font-size:14px;'> Аргинин 1496мг 
Лейцин 2891мг 
Изолейцин 1953мг 
Валин 2145мг 
Лизин 2553мг
...
echo "<div class='clearer'>"."</div>";
    ...
    echo "<div class='application'>
     ...
     <span style='font-size:14px;'> смешать 5 ложек порошка (229 г) с 450 г воды или нежирного молока (желательно взбить смесь в миксере с кусочками льда). Принимать от 1 до 3 порций в день в дополнение к Вашему обычному рациону. </span> 
