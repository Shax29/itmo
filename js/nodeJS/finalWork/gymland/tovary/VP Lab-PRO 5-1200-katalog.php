...
?> 
  ...
  <?php
	...
	$_POST[sostav] = ('Калорийность 113 ккал;\r\nПротеины 	22,9 г;');
...
$sql_tov="SELECT * FROM tovary WHERE photo='159.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/159.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
...
$sql_sklad="SELECT * FROM sklad WHERE photo='159.jpeg'";
