...
$sql_tov="SELECT * FROM tovary WHERE photo='152.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/152.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
       ...
       <form method='post' action='../templates/comment.php'>
        ...
        <div class='review'>
          ...
          <?php
              ...
              $sql="SELECT * FROM tovary WHERE id=''";
              $rez=mysql_query($sql);
         ...
         //Удаление отзыва
	          ...
	          $sql="DELETE FROM otzyv WHERE id_otzyv=";	
	          mysql_query($sql);
              echo "<script>location.replace('/products/__.php?items=');</script>";
        ...
        //Редактирование отзыва
             ...
             $sql="UPDATE otzyv SET name='',comment='',advantage='',disadvantage='' WHERE id_otzyv=''";
             mysql_query($sql);
             echo "<script>location.replace('/products/__.php?items=');</script>";
          ...
          <!-- <form method='get' action=''> -->
              ...
              $sql="SELECT * FROM otzyv WHERE id_tovar=''";
              $rez=mysql_query($sql);
              $otzyv=mysql_fetch_array($rez);
             ...
             echo "<span style='font-size:12px;'> $otzyv[name], $otzyv[date] г. </span> 
                <span style='float:right; font-size:14px;'> <a href='?items=&edit_otzyv='> Редактировать </a> / <a href='?items=&del_otzyv='> Удалить </a> </span>"; 
            ...
            echo "</div>";
                 ...
                 $sql="SELECT * FROM otzyv WHERE id_otzyv=''";
                 $rez=mysql_query($sql);
                  ...
                  <a href='/products/__.php?items='> Назад </a> 
                  </div>";
...
$sql="INSERT INTO otzyv (id_tovar, comment, advantage, disadvantage, name, date) VALUES ('', '', '', '', '', '')";
$rez=mysql_query($sql); 
