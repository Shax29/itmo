...
<html class='no-js' lang='en'>
  ...
  <?php
    ...
    <div class='large-12-center'>
      ...
      <li>  Optimum Nutrition, True Mass  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='146.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/146.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
