...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <div class="large-12-center">
      ...
      <li> CytoSport CytoGainer , 5400 гр. </li>
      </ul>
   <form action='' method='post' class='tovary_week_form' id="sort">  
   <div class='product_conteiner'> 
     <?php 
 $sql="SELECT * FROM tovary WHERE manuf='CytoSport' AND nazv='CytoGainer'";
 $rez=mysql_query($sql);
 ...
 foreach($sostav as $tov[sostav]) {}
     ...
     <img src='../photos/$tov[photo]' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
     
    echo "<div class='product_info'>
     
     <div class='product_title'>
     <span class='title_name'> $tov[manuf], $tov[nazv] </span> <span class='tovar_of_the_week'> Товар недели! </span>
     <br> <span class='title_and_mass'> $tov[category], tov[mass] гр. (18 порций) </span>  
     ...
     <span class='price'> Цена: $tov[cena] руб. </span>
     <br> 
    ...
    echo "<div class='amount_product'>
      ...
      <a href='#'>
	  <i class='icon icon-minuss'><img src='../img/minus.png' width='12' height='12'></i> 
	  </a>
      </div>
      </span>
      ...
      <a href='#'>
      <i class='icon icon-pluss'> <img src='../img/plus.png' width='12' height='12'></i> 
      </a>
      </div>
      </span>
