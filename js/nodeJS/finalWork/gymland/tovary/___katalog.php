...
<html class='no-js' lang='en'>
 ...
 $sql_tov='SELECT * FROM tovary WHERE nazv=''';
 ...
 while($tov=mysql_fetch_array($rez_tov)) {  
     ...
     <img src='../photos/0.jpeg' name='photo' title=', ' alt=', '/>
     </div>";
     
    echo "<div class='product_info'>
     
     <div class='product_title'>
     <span class='title_name' name='title'> ,  </span> <span class='tovar_of_the_week'> Товар недели! </span>
