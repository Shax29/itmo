...
<html class='no-js' lang='en'>
  ...
  <?php
    ...
    <div class='large-12-center'>
      ...
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Бандажи </a></li>
      <li>  , Whey Protein  </li>
      </ul>
 ...
 while($tov=mysql_fetch_array($rez_tov)) {  
     ...
     <img src='../photos/' name='photo' title=', Whey Protein' alt=', Whey Protein'/>
     </div>";
     
    echo "<div class='product_info'>
     
     <div class='product_title'>
     <span class='title_name' name='title'> , Whey Protein </span> <span class='tovar_of_the_week'> Товар недели! </span>
     <br> <span class='title_and_mass' name='title_and_mass'> Бандажи, 1000 . () </span>  
