...
?> 
  ...
  <?php
	...
	$_POST[sostav] = ('Витамин В6 - 10,5 мг;\r\nМагний - 450 мг;\r\nЦинк - 30 мг');
    ...
    <div class='large-12-center'>
      ...
      <li class='geiner_breadcrumbs'><a href='../sport_eat/amino.php?category=Аминокислоты' rel='sport_eat'> Аминокислоты </a></li>
      <li>  Twinlab, ZMA Fuel  </li>
      </ul> -->
      
      <ul class='breadcrumbs'>
      <li><a href='../index.php' rel='home'> Главная </a></li>
	  <li><a href='../sport_eat.php' rel='sport_eat'> Спортивное питание </a></li>
      <li><a href='../sport_eat/amino.php?category=Аминокислоты' rel='sport_eat'> Аминокислоты </a></li>
      <li>  Twinlab, ZMA Fuel  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='160.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/160.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
...
$sql_sklad="SELECT * FROM sklad WHERE photo='160.jpeg'";
       ...
       <form method='post' action=''>
        ...
        <div class='review'>
         ...
         //Удаление отзыва
	          ...
	          mysql_query($sql);
              echo "<script>location.replace('/products/$tov[manuf]-$tov[nazv]-$tov[mass].php?items=$_GET[items]');</script>";
