...
<html class='no-js' lang='en'>
  ...
  <?php
	...
	$_POST[sostav] = ('L-аланин	234 мг;
L-аргинин	132 мг;
L-аспарагиновая кислота	480 мг;
L-цистеин	138 мг;
L-глютаминовая кислота	690 мг;
L-глицин	84 мг;');
    ...
    <div class='large-12-center'>
      ...
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Аминокислоты </a></li>
      <li>  Olimp, Anabolic Amino 5500  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='134.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/134.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
