...
Витамин B12 - 100мкг;');
    ...
    <div class='large-12-center'>
      ...
      <li>  Gaspari Nutrition, BCAA 6000  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='139.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/139.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
