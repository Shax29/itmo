...
<html class='no-js' lang='en'>
  ...
  <body>
  <?php
    $_POST[preference] = ('Выберите вкус,Клубника');
	$preference = explode(",", $_POST[preference]);
    foreach($preference as $_POST[preference]) {}
	
	$_POST[sostav] = ('Калорийность 1538кДж/ 367 ккал;
Белки 28.1 г;
Углеводы 61.5 г;
Втч сахара 4.6 г;
Диетическое волокно 0.9 г;
Жиры 0.8 г;
Втч насыщенные жиры 0.5 г;
Натрий 209 мг;
Калий 434 мг;');
    ...
    <div class='large-12-center'>
	  ...
	  <li class='sport_eat_breadcrumbs'><a href='../sport_eat.php?category=Гейнер' rel='sport_eat'> Спортивное питание </a></li>
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Гейнер </a></li>
      <li>  Nature's Best, IsoPure Mass  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='0.jpeg'";
...
$bonus=ceil($bonus); 
     ...
     <img src='../photos/0.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
...
$sql_sklad="SELECT * FROM sklad WHERE id_tov=''";
...
<td class='shapka_sklad'> Статус </td>
    ...
    foreach($kol_sklad as $sklad[kol])
  {
      echo "<tr>
        ...
        <td class='body_sklad'>$sklad[preference]</td>
        <td class='body_sklad'>$sklad[kol] шт.</td>
