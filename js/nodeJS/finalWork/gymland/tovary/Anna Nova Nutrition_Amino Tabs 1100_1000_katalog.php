...
<html class='no-js' lang='en'>
  ...
  <?php
    ...
    <div class='large-12-center'>
      ...
      <li>  Anna Nova Nutrition, Amino Tabs 1100  </li>
      </ul>
   <form action='' method='post' class='tovary_week_form' id='sort'>  
   <div class='product_conteiner'> 
     <?php 
 
 $sql_tov='SELECT * FROM tovary WHERE nazv='Amino Tabs 1100'';
 ...
 $tov=Array;   
     ...
     <img src='../photos/' name='photo' title='Anna Nova Nutrition, Amino Tabs 1100' alt='Anna Nova Nutrition, Amino Tabs 1100'/>
     </div>";
     
    echo "<div class='product_info'>
     
     <div class='product_title'>
     <span class='title_name' name='title'> Anna Nova Nutrition, Amino Tabs 1100 </span> <span class='tovar_of_the_week'> Товар недели! </span>
     <br> <span class='title_and_mass' name='title_and_mass'> Витамины, 1000 таблеток. () </span>  
     ...
     <br> <span class='old_price' name='old_price'> Старая цена: 1100 руб. </span>
...
echo "</div>";
    ...
    <strong style='font-size:14px;'>Amino Tabs 1100</strong>
