...
<html class='no-js' lang='en'>
  ...
  <body>
  <?php
    $_POST[preference] = ('Выберите вкус,Орех-семечки');
	$preference = explode(",", $_POST[preference]);
    foreach($preference as $_POST[preference]) {}
	
	$_POST[sostav] = ('Калорийность 235 ккал;
Белки 3,4 г;
Углеводы 26,3 г;
  в.т.ч сахар 15,9 г;
Жиры 9,2 г;
  в.т.ч насыщенные жиры 3,7 г;
Клетчатка 2,1 г;
Натрий 0,05 г;');
    ...
    <div class='large-12-center'>
      ...
      <li class='geiner_breadcrumbs'><a href='../sport_eat/geiner.php' rel='sport_eat'> Батончики </a></li>
      <li>  VP Lab, Biobar  </li>
      </ul>
...
$sql_tov="SELECT * FROM tovary WHERE photo='133.jpeg'";
...
while($tov=mysql_fetch_array($rez_tov)) {
     ...
     <img src='../photos/133.jpeg' name='photo' title='$tov[manuf], $tov[nazv]' alt='$tov[manuf], $tov[nazv]'/>
     </div>";
