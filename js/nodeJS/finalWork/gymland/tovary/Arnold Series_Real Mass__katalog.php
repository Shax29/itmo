...
<html class='no-js' lang='en'>
 ...
 while($tov=mysql_fetch_array($rez_tov)) {  
     ...
     <img src='../photos/' name='photo' title='Arnold Series, Real Mass' alt='Arnold Series, Real Mass'/>
     </div>";
     
    echo "<div class='product_info'>
     
     <div class='product_title'>
     <span class='title_name' name='title'> Arnold Series, Real Mass </span> <span class='tovar_of_the_week'> Товар недели! </span>
     <br> <span class='title_and_mass' name='title_and_mass'> Не выбрана категория,  . () </span>  
...
echo "</div>";
    ...
    <strong style='font-size:14px;'>Real Mass</strong>
